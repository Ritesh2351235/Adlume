  ...
  (
    ...
    return (
      <div className={cn("relative min-h-screen", className)} ref={ref} {...props}>
        <div className="absolute inset-0 bg-gradient-to-br from-purple-50/50 via-background to-teal-50/50 dark:from-purple-950/20 dark:via-background dark:to-teal-950/20" />
        <div className="absolute top-0 z-[0] h-full w-full bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.15),rgba(255,255,255,0))] dark:bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]" />
        ...
        <section className="relative max-w-full mx-auto z-10">
          ...
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-20 md:py-28 gap-12 md:px-8">
            ...
            {bottomImage && (
              <div className="mt-20 mx-4 md:mx-10 relative z-10">
                <div className="relative">
                  <img
                    src={bottomImage.light}
                    className="w-full shadow-2xl rounded-xl border border-gray-200/50 dark:hidden"
                    alt="Dashboard preview"
                  />
                  <img
                    src={bottomImage.dark}
                    className="hidden w-full shadow-2xl rounded-xl border border-gray-800/50 dark:block"
                    alt="Dashboard preview"
                  />
